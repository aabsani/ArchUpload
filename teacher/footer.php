...
<!-- ChartJS -->
<script src="../admin/assets/vendor_components/chart-js/chart.js"></script>

<!-- Sparkline -->
<script src="../admin/assets/vendor_components/jquery-sparkline/dist/jquery.sparkline.js"></script>

<!-- jvectormap -->
<script src="../admin/assets/vendor_plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
<script src="../admin/assets/vendor_plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>

<!-- jQuery Knob Chart -->
<script src="../admin/assets/vendor_components/jquery-knob/js/jquery.knob.js"></script>
...
<!-- datepicker -->
<script src="../admin/assets/vendor_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.js"></script>

<!-- Bootstrap WYSIHTML5 -->
<script src="../admin/assets/vendor_plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.js"></script>
...
<script src="../admin/js/pages/dropdown.js"></script>

<!-- weather for demo purposes -->
<script src="../admin/assets/vendor_plugins/weather-icons/WeatherIcon.js"></script>
<script>
